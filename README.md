...
TKTDD in [Rust](https://www.rust-lang.org) with [cargo](https://doc.rust-lang.org/cargo/index.html)

## First time with Rust ?
...
You get some tests in `src/tennis.rs` which should serve you as a specification of what you can code.
